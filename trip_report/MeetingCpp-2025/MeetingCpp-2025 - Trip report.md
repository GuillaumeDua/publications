...
![meeting_cpp_2025_tshirt_logo center full](./screenshots/meeting_cpp_2025_tshirt_logo.jpg)
...
- [Conference - Meeting Cpp 2025 - Trip report](#conference---meeting-cpp-2025---trip-report)
  ...
  - [📅 11/06/2025](#-11062025)
    - [🗣️**Jens Weller**: Welcome Message](#️jens-weller-welcome-message)
      - [Sponsors](#sponsors)
      - [Creating a **safe** and **inclusive** environment](#creating-a-safe-and-inclusive-environment)
      - [In memory of Rainer Grimm](#in-memory-of-rainer-grimm)
    - [🗣️**Anthony Williams**: Software and safety (Opening Keynote)](#️anthony-williams-software-and-safety-opening-keynote)
      - [What safety means ?](#what-safety-means-)
      - [Standards and mindset](#standards-and-mindset)
      - [Why systems fail ?](#why-systems-fail-)
      - [Undefined behaviors (UB) and reliability](#undefined-behaviors-ub-and-reliability)
      - [Contracts in C++26 as a safety leverage](#contracts-in-c26-as-a-safety-leverage)
      - [Defense in depth, using appropriate strategy and tools](#defense-in-depth-using-appropriate-strategy-and-tools)
      - [The Arene Base library](#the-arene-base-library)
      - [My takeaway](#my-takeaway)
    - [🗣️**Sebastian Theophil**: To Err is Human: Robust Error Handling in C++26](#️sebastian-theophil-to-err-is-human-robust-error-handling-in-c26)
      - [The landscape of error handling: historical perspective](#the-landscape-of-error-handling-historical-perspective)
      - [The modern stuffs: std::expected](#the-modern-stuffs-stdexpected)
      - [The modern stuffs: contracts](#the-modern-stuffs-contracts)
      - [Library hardening in C++26](#library-hardening-in-c26)
      - [Practical rules for real-world code](#practical-rules-for-real-world-code)
      - [About `ThinkCell`'s error reporting](#about-thinkcells-error-reporting)
      - [My takeaway](#my-takeaway-1)
      - [Additional resources: learn more about error handling](#additional-resources-learn-more-about-error-handling)
    - [🗣️**Nicolai Josuttis**: Using `std::generator<>` in Practice](#️nicolai-josuttis-using-stdgenerator-in-practice)
      - [What coroutines are (and aren't)](#what-coroutines-are-and-arent)
      - [What std::generator brings](#what-stdgenerator-brings)
      - [Pitfalls and caveats](#pitfalls-and-caveats)
      - [My takeaway](#my-takeaway-2)
      - [Additional resources: learn more about coroutines](#additional-resources-learn-more-about-coroutines)
    - [🗣️**Sandor Dargo**: Code Reviews: Building Better Code and Stronger Teams](#️sandor-dargo-code-reviews-building-better-code-and-stronger-teams)
      - [The value of code reviews](#the-value-of-code-reviews)
      - [Common arguments and misconceptions](#common-arguments-and-misconceptions)
      - [The human aspects](#the-human-aspects)
      - [Sandor's **AIR** methodology](#sandors-air-methodology)
      - [My takeaway](#my-takeaway-3)
        - [Bonus: How I personally do code reviews](#bonus-how-i-personally-do-code-reviews)
      - [Conclusion](#conclusion)
    - [🗣️**Anders Schau Knatten** The Two Memory Models](#️anders-schau-knatten-the-two-memory-models)
      - [What are the two memory models ?](#what-are-the-two-memory-models-)
      - [At language-level](#at-language-level)
      - [At CPU-level](#at-cpu-level)
      - [Mental model for developers](#mental-model-for-developers)
      - [My takeaway](#my-takeaway-4)
      - [Additional resources](#additional-resources)
  - [📅 11/07/2025](#-11072025)
    - [🗣️**Jens Weller** - Good Morning Meeting C++](#️jens-weller---good-morning-meeting-c)
      - [My takeaway](#my-takeaway-5)
    - [🗣️ **Frances Buontempo** - Center Keynote - Stoopid Questions](#️-frances-buontempo---center-keynote---stoopid-questions)
      - [My takeaway](#my-takeaway-6)
    - [🗣️ **Jonathan Müller** - Cache-Friendly C++](#️-jonathan-müller---cache-friendly-c)
      - [Cache-friendly code: why does it matter ?](#cache-friendly-code-why-does-it-matter-)
      - [Data structures matter](#data-structures-matter)
      - [Type size and layout affect cache use](#type-size-and-layout-affect-cache-use)
      - [Prefetching \& cache lines](#prefetching--cache-lines)
      - [Code is data too](#code-is-data-too)
      - [Data-Oriented Design (DOD)](#data-oriented-design-dod)
      - [Multicore pitfalls](#multicore-pitfalls)
      - [My takeaway](#my-takeaway-7)
    - [🗣️ **Andreas Fertig** - Embedded-Friendly C++: Features That Make a Difference](#️-andreas-fertig---embedded-friendly-c-features-that-make-a-difference)
      - [Content](#content)
      - [My takeaway](#my-takeaway-8)
    - [🗣️ **Daniela Engert** - Towards Safety and Security in C++26](#️-daniela-engert---towards-safety-and-security-in-c26)
      - [Content](#content-1)
      - [My takeaway](#my-takeaway-9)
    - [🗣️ **Raymi Klingers** - 25+ Years of pathfinding problems with C++](#️-raymi-klingers---25-years-of-pathfinding-problems-with-c)
      - [Content](#content-2)
      - [My takeaway](#my-takeaway-10)
  - [📅 11/08/2025](#-11082025)
    - [🗣️ **Klaus Iglberger** - The Real Problem of C++](#️-klaus-iglberger---the-real-problem-of-c)
      - [Safety vs. performance: an historical tradeoff](#safety-vs-performance-an-historical-tradeoff)
      - [Bounds safety](#bounds-safety)
      - [Undefined behaviors: the silent killers](#undefined-behaviors-the-silent-killers)
      - [Type safety through strong types](#type-safety-through-strong-types)
      - [Lifetime safety: value semantics over inheritance](#lifetime-safety-value-semantics-over-inheritance)
      - [Conclusion: the real problem is a **people problem**](#conclusion-the-real-problem-is-a-people-problem)
      - [My takeaway](#my-takeaway-11)
      - [Additional sources](#additional-sources)
    - [🗣️ **Roth Michaels** - How to become obsolete: a guide to software engineering mentorship](#️-roth-michaels---how-to-become-obsolete-a-guide-to-software-engineering-mentorship)
      - [Why become obsolete ?](#why-become-obsolete-)
      - [Shared technical leadership](#shared-technical-leadership)
      - [Identifying and developing leaders](#identifying-and-developing-leaders)
      - [Practical mentorship techniques](#practical-mentorship-techniques)
        - [Sharing knowledge](#sharing-knowledge)
        - [Talking through engineering problems, asking them](#talking-through-engineering-problems-asking-them)
        - [Pair-debugging is an incredibly powerful teaching tool](#pair-debugging-is-an-incredibly-powerful-teaching-tool)
        - [Code-reviews: differenciate types of comments](#code-reviews-differenciate-types-of-comments)
        - [Encourage psychological safety](#encourage-psychological-safety)
      - [Q\&A](#qa)
      - [My Takeaway](#my-takeaway-12)
    - [🗣️ **Kerstin Keller** - Why managing C++ dependencies is hard (and what to do about it)](#️-kerstin-keller---why-managing-c-dependencies-is-hard-and-what-to-do-about-it)
      - [What are dependencies \& what is **dependency management** ?](#what-are-dependencies--what-is-dependency-management-)
      - [How developers handle dependencies nowadays ?](#how-developers-handle-dependencies-nowadays-)
      - [Why C++ dependencies management is unique and hard ?](#why-c-dependencies-management-is-unique-and-hard-)
      - [Inputs from the Q\&A](#inputs-from-the-qa)
      - [My Takeaway](#my-takeaway-13)
      - [Additional resources](#additional-resources-1)
    - [🗣️ **Jens Weller** - Meeting C++ update](#️-jens-weller---meeting-c-update)
      - [What's next ?](#whats-next-)
      - [2026 conference](#2026-conference)
      - [Hommage to Rainer Grimm](#hommage-to-rainer-grimm)
    - [⚡Lightning talks](#lightning-talks)
      - [⚡ **James McNellis** Our most teacherous adversary](#-james-mcnellis-our-most-teacherous-adversary)
      - [⚡ **Rahel Natalie Engel** - let them eat cake](#-rahel-natalie-engel---let-them-eat-cake)
      - [⚡ **Robin Savenen Soderholm** - vector to array: let the compiler turn heap into static storage](#-robin-savenen-soderholm---vector-to-array-let-the-compiler-turn-heap-into-static-storage)
      - [⚡ **Ganest Rengasamy** - Meet Qt](#-ganest-rengasamy---meet-qt)
      - [⚡ **Hannah Lenk** - Start teaching C++](#-hannah-lenk---start-teaching-c)
      - [⚡ **Jens Weller** - binary trees](#-jens-weller---binary-trees)
        - [My takeaway](#my-takeaway-14)
    - [🗣️ **James McNellis** - Closing Keynote - A little introduction to control flow integrity](#️-james-mcnellis---closing-keynote---a-little-introduction-to-control-flow-integrity)
      - [My takeaway](#my-takeaway-15)
    - [🤚 Allow me a disgression here](#-allow-me-a-disgression-here)
      - [Let's code](#lets-code)
      - [So what is the takeaway for me on this ?](#so-what-is-the-takeaway-for-me-on-this-)
...
- Gold sponsors: Think-cell, KDAB, Bloomberg
- Video sponsors: [Woven by Toyota](https://woven.toyota/en/), JetBrains
- T-shirt sponsor: HRT
- Online sponsor: Qt
...
![Jens Weller: Meeting C++ update - survey](./screenshots/14_02_Jens_Weller__Meeting_Cpp_update__Cippi_and_Rainer.jpg)
...
![Anthony Willians - Software and safety (opening_keynote) - Swiss Cheese model](./screenshots/01_Anthony_Willians__Software_and_safety__opening_keynote.jpg)
...
![Sebastian Theophil: To Err is Human: Robust Error Handling in C++26 - contract customization](./screenshots/02_Sebastian_%20Theophil__To_Err%20_is_Human%20_Robust__Error%20_Handling_in_cpp26.jpg)
...
![Nicolai Josuttis: Using `std::generator<>` in Practice - `std::generator<>`](./screenshots/03_Nicolai_Josuttis__std_generator_in_practice.jpg)
...
![Nicolai Josuttis: Using `std::generator<>` in Practice - `generator<>` vs. class](./screenshots/03_2_Nicolai_Josuttis__std_generator_in_practice.jpg)
...
![Sandor Dargo: Code Reviews: Building Better Code and Stronger Teams - AIR formula](./screenshots/04_Sandor_Dargo__building_better_code_and_stronger_teams__AIR.jpg)
...
![Anders Schau Knatten: The Two Memory Models - TSO example](./screenshots/05_Anders_Schau_Knatten__The_Two_Memory_Models.jpg)
...
![meeting_cpp_2025_tshirt_logo](./screenshots/meeting_cpp_2025_tshirt_logo.jpg)
...
![Frances Buontempo: Center Keynote - Stoopid Questions - who never](./screenshots/06_Frances_Buontempo__Stoopid_Questions.jpg)
...
![Jonathan Müller: Cache-Friendly C++ - struct members ordering](./screenshots/07_01__Jonathan_Muller__cache_friendly_cpp__layout_members_ordering.jpg)
...
![Jonathan Müller: Cache-Friendly C++ - takeaway](./screenshots/07_02__Jonathan_Muller__cache_friendly_cpp__takeaway.jpg)
...
![Jonathan Müller: Cache-Friendly C++ - DOD](./screenshots/07_03__Jonathan_Muller__cache_friendly_cpp__DOD_example.jpg)
![Jonathan Müller: Cache-Friendly C++ - DOD benchmarks](./screenshots/07_04__Jonathan_Muller__cache_friendly_cpp__DOD_performances.jpg)
...
![Andreas Fertig: Embedded-Friendly C++: Features That Make a Difference - bit_cast](./screenshots/08_01_Andreas_Fertig__Embedded_Friendly_Cpp_Features_That_Make_a_Difference__bit_cast.jpg)
![Andreas Fertig: Embedded-Friendly C++: Features That Make a Difference - start_lifetime](./screenshots/08_02_Andreas_Fertig__Embedded_Friendly_Cpp_Features_That_Make_a_Difference__start_lifetime.jpg)
...
![Daniela Engert: Towards Safety and Security in C++26 - MSVC hardened STL](./screenshots/09_01_Daniela_Engert__Towards_Safety_and_Security_in_Cpp26__hardened_STL.jpg)
![Daniela Engert: Towards Safety and Security in C++26 - contracts](./screenshots/09_02_Daniela_Engert__Towards_Safety_and_Security_in_Cpp26__contracts.jpg)
![Daniela Engert: Towards Safety and Security in C++26 - contracts semantic](./screenshots/09_03_Daniela_Engert__Towards_Safety_and_Security_in_Cpp26_contracts_semantic.jpg)
...
![Raymi Klingers: 25+ Years of pathfinding problems with C++ - The path of robustness](./screenshots/10_Raymi_Klingers__25_Years_of_pathfinding_problems_with_Cpp.jpg)
...
![Klaus Iglberger: The Real Problem of C++ - my personnal opinion](./screenshots/11_01_Klaus_Iglberger__The_Real_Problem_of_Cpp.jpg)
![Klaus Iglberger: The Real Problem of C++ - expert's opinion](./screenshots/11_02_Klaus_Iglberger__The_Real_Problem_of_Cpp.jpg)
![Klaus Iglberger: The Real Problem of C++ - current state of discussion](./screenshots/11_03_Klaus_Iglberger__The_Real_Problem_of_Cpp.jpg)
![Klaus Iglberger: The Real Problem of C++ - about reference semantic](./screenshots/11_04_Klaus_Iglberger__The_Real_Problem_of_Cpp.jpg)
![Klaus Iglberger: The Real Problem of C++ - conclusion](./screenshots/11_05_Klaus_Iglberger__The_Real_Problem_of_Cpp.jpg)
...
![Roth Michaels: How to become obsolete: a guide to software engineering mentorship - identifying leaders](./screenshots/12_Ruth_Michaels__How_to_gbecome_obsolete.jpg)
...
![Kerstin Keller: Why managing C++ dependencies is hard - dependency graph](./screenshots/13_00_Kerstin_Keller__Why_managing_Cpp_dependencies_is_hard__graph.jpg)
...
![Kerstin Keller: Why managing C++ dependencies is hard - survey](./screenshots/13_01_Kerstin_Keller__Why_managing_Cpp_dependencies_is_hard__survey.jpg)
...
![Kerstin Keller: Why managing C++ dependencies is hard - dependency manager purpose](./screenshots/13_02_Kerstin_Keller__Why_managing_Cpp_dependencies_is_hard__dependency_manager_purpose.jpg)
![Kerstin Keller: Why managing C++ dependencies is hard - providing dependencies](./screenshots/13_03_Kerstin_Keller__Why_managing_Cpp_dependencies_is_hard__providing_dependencies.jpg)
...
![Jens Weller: Meeting C++ update - survey](./screenshots/14_01_Jens_Weller__Meeting_Cpp_update__survey.jpg)
...
![Jens Weller: Meeting C++ update - Cippi and Rainer](./screenshots/14_02_Jens_Weller__Meeting_Cpp_update__Cippi_and_Rainer.jpg)  
...
![James McNellis: Our most teacherous adversary - 3 states of booleans](./screenshots/15_James_McNellis_Our_most_teacherous_adversary.jpg)
...
![screenshot - Rahel Natalie Engel - let them eat cake - catpie](./screenshots/16_rahel_natalie_engel__let_them_eat_cake_catpie.jpg)
...
![Robin Savenen Soderholm: vector to array - usage](./screenshots/17_Robin_Savenen_Soderholm__vector_to_array__usage.jpg)
...
![Ganest Rengasamy: Meet Qt](./screenshots/18_Ganest_Rengasamy__Meet_Qt.jpg)
...
![Hannah Lenk: Start teaching C++](./screenshots/19_Hannah_Lenk__start_teaching_Cpp.jpg)
...
![Jens Weller: binary trees](./screenshots/20_Jens_Weller__Binary_trees.jpg)
...
![James McNellis: Closing Keynote - A little introduction to control flow integrity - Calls and Returns](./screenshots/21_01_James_McNellis__Closing%20Keynote__A_little_introduction_to_control_flow_integrity.jpg)
![James McNellis: Closing Keynote - A little introduction to control flow integrity - PAC](./screenshots/21_02_James_McNellis__Closing%20Keynote__A_little_introduction_to_control_flow_integrity.jpg)
![James McNellis: Closing Keynote - A little introduction to control flow integrity - return address protection with PAC](./screenshots/21_03_James_McNellis__Closing%20Keynote__A_little_introduction_to_control_flow_integrity.jpg)
![James McNellis: Closing Keynote - A little introduction to control flow integrity - Control flow guard vs. Clang CFI](./screenshots/21_04_James_McNellis__Closing%20Keynote__A_little_introduction_to_control_flow_integrity.jpg)
